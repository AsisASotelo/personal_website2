...
export const PROJECTS = [{
...

    {
        ...
        body: "Final project of the IBM Data Science Specialization. The entire data science methodology, which begins with identifying the problem. In this case can we determine which borough of New York is best for gym accesibility and quality. Data from gym was scraped utilizing the Foursquare API."
...

    {
        ...
        body: "Creates an image of a Mandelbulb which is a 3d extension of the 2-d Mandelbrot set. The image is 500 by 500 pixels and implements distance estimation for the ray tracing allowing some shadowing to appear in the image. Computational complexity causes a loading time of 3 minutes on average. All of the work was done on a Raspberry PI 3B+. "
